 ...
 *
 */
public class IndexOutputFormatHTM<S extends Shape>
    ...
    public static class IndexRecordWriter<S extends Shape> extends RecordWriter<IntWritable, S> {
        ...
        private Map<Integer, PartitionHTM> partitionsInfo = new ConcurrentHashMap<Integer, PartitionHTM>();
        ...
        public IndexRecordWriter(TaskAttemptContext task, String name, Path outPath,
            ...
            this.partitioner = PartitionerHTM.getPartitioner(conf);
        ...
        public IndexRecordWriter(PartitionerHTM partitioner, boolean replicate,
        ...
        public void write(IntWritable partitionID, S value) throws IOException {
            ...
            if (id < 0) {
                ...
                PartitionHTM partition = partitionsInfo.get(id);
        ...
        private void closePartition(final int id) {
            final PartitionHTM partitionInfo = partitionsInfo.get(id);
        ...
        private OutputStream getOrCreateDataOutput(int id) throws IOException {
            ...
            if (out == null) {
                ...
                PartitionHTM partition = new PartitionHTM();
                partition.htmId = partitioner.getHTMidInfo(id).htmId;
                ...
                if (localIndexer == null) {
                    ...
                    String filename = String.format("part-%d-", partition.htmId.getId());
